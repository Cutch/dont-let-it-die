    ...
    public function getData(): array
    {
        $data = [
            ...
            'bone-scythe' => [
                ...
                'onDraw' => function (DLD_Game $game, $item, &$data) {
                    $card = $data['card'];
            ...
            'camp-walls' => [
                ...
                'onNightDrawCard' => function (DLD_Game $game, $item, &$data) {
            ...
            'knowledge-hut' => [
                ...
                'onUse' => function (DLD_Game $game, $item) {
                    usePerDay($item, $game);
                },
                'requires' => function (DLD_Game $game, $item) {
                    return getUsePerDay($item, $game) < 1;
                },
                'onInvestigateFire' => function (DLD_Game $game, $item, &$data) {
            ...
            'cooking-hut' => [
                ...
                'onEat' => function (DLD_Game $game, $item, &$data) {
                    $data['health'] += 2;
                },
            ],
            'carving-knife' => [
            ...
            'planning-hut' => [
                ...
                'skills' => [
                    'skill1' => [
                        ...
                        'onDraw' => function (DLD_Game $game, $skill, &$data) {
                            $deck = $data['deck'];
                            if (
            ...
            'stone-hammer' => [
                ...
                'onGetActionCost' => function (DLD_Game $game, $item, &$data) {
            ...
            'bandage' => [
                ...
                'onIncapacitation' => function (DLD_Game $game, $item, &$data) {
            ...
            'skull-shield' => [
                ...
                'onEncounterPre' => function (DLD_Game $game, $item, &$data) {
                    $damageTaken = $game->encounter->countDamageTaken($data);
                    $char = $game->character->getCharacterData($item['characterId']);
            ...
            'cooking-pot' => [
                ...
                'onCook' => function (DLD_Game $game, $item, &$data) {
                    $char = $game->character->getCharacterData($item['characterId']);
            ...
            'stock-hut' => [
                ...
                'onGetTradeRatio' => function (DLD_Game $game, $item, &$data) {
                    $data['ratio'] = 2;
                },
            ],
            'whip' => [
            ...
            'bola' => [
                ...
                // 'onEncounter' => function (DLD_Game $game, $item, &$data) {
                //     $char = $game->character->getCharacterData($item['characterId']);
            ...
            'gem-y-necklace' => [
                ...
                'onCraftAfter' => function (DLD_Game $game, $unlock, &$data) {
